...
class PasoonateTest extends TestCase
{
    public function testParser()
    {
        ...
        $date = $pasoonate->jalali()->parse('yyyy/MM/dd HH:mm:ss', '1403/12/30 20:12:00')->format('yyyy/MM/dd HH:mm:ss');

        $this->assertEquals($date, '1403/12/30 20:12:00', 'Jalali Date is ok');
    }
